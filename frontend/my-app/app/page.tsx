...
import { Search, Star, MessageSquare, ChevronRight } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const categories: Category[] = [
    { icon: '🏗️', label: 'Новостройки', color: 'bg-blue-50' },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#0093d3] py-5">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex gap-4">
            <div className="w-137.5 h-9 bg-white rounded-sm shadow-lg flex overflow-hidden ring-2 ring-yellow-400">
              <input
                type="text"
                value={searchQuery}
            ...
            <button
              ...
              "
            >
              <Search className="w-6 h-6 transition-transform duration-300 group-hover:translate-x-1" />
              Найти
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className='grid grid-cols-4 place-items-start place-content-start gap-y-4 text-start'>
        ...
        <div>
            ...
            {listings.map((listing) => (
              <div key={listing.id} className="group">
                <div className="relative">
                  ...
                  <div className="absolute top-2 right-2 bg-gray-500 bg-opacity-60 group-hover:bg-orange-500 px-1 text-white rounded text-sm flex items-center justify-center gap-1">
          ...
          <button className="mt-6 mx-auto flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium">
